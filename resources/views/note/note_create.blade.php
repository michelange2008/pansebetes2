...
@section('contenu')
  ...
  <div class="container-fluid">
    ...
    <form class="" action="{{ 'notes.store' }}" method="post">
      @csrf
      <div class="form-row justify-content-start d-flex flex-row">
            <div class="col-md-6 border p-3 mr-1">
              <p class='lead'>
                <img class="img-25 pb-1" src="{{url('storage/img/note/troupeau.svg')}}" alt="">
            ...
            <div class="col-md-6 border p-3">
              <p class='lead'>
                <img class="img-25 pb-1" src="{{ url('storage/img/note/count.svg')}}" alt="">
          ...
          <div class="form-row mt-3">
            <div class="col-md-10 border p-2">
              <p class='lead'>
                <img class="img-25 pb-1" src="{{url('storage/img/note/cerveau.svg')}}" alt="">
          ...
          <div class="form-row mt-3">
            <div class="col-md-10 border p-2 my-3">
              <p class='lead'>
                <img class="img-25 pb-1" src="{{url('storage/img/note/application.svg')}}" alt="">
